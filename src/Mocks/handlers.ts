...
export const handlers = [
  http.get('https://api.themoviedb.org/3/discover/movie?api_key=97f696b70496b36f12d4131b9f877c33&include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc', () => {
